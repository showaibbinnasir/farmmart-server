...
async function run() {
    try {
        ...
        app.put('/all_users/update/:id', async (req, res) => {
            const id = req.params.id;
            ...
            const result = await all_users.updateOne(filter, updatedUser, option);
            res.send(result);
        })
        app.put('/all_needs/update/:id', async (req, res) => {
            const id = req.params.id;
            const filter = { _id: new ObjectId(id) }
            const user = req.body;
            const option = { upsert: true }
            ...
            const result = await all_needs.updateOne(filter, updatedUser, option);
            res.send(result);
        })
        app.put('/all_animals/update/:id', async (req, res) => {
            const id = req.params.id;
            const filter = { _id: new ObjectId(id) }
            const user = req.body;
            const option = { upsert: true }
